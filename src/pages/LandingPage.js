        ...
        <div className="flex-1">
          ...
          <div className="flex gap-4 justify-center md:justify-start">
            ...
            <button
              ...
              className="border border-blue-600 text-blue-600 px-8 py-3 rounded-lg text-lg font-medium hover:bg-blue-100"
            >
              Learn More
            </button>
          </div>
      ...
      <section id="how-it-works" className="py-24 px-8 bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="bg-blue-50 p-6 rounded-xl text-center">
            ...
            <h4 className="text-xl font-bold text-blue-700 mb-2">Create Account</h4>
          ...
          <div className="bg-blue-50 p-6 rounded-xl text-center">
            ...
            <h4 className="text-xl font-bold text-blue-700 mb-2">Ask Questions</h4>
            <p className="text-blue-900">
          ...
          <div className="bg-blue-50 p-6 rounded-xl text-center">
            ...
            <h4 className="text-xl font-bold text-blue-700 mb-2">Learn and Grow</h4>
            <p className="text-blue-900">
